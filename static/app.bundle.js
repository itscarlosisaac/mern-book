...
var _IssueAdd = __webpack_require__(32);
...
IssueRow.propTypes = {
    issue_id: _propTypes2.default.string.isRequired,
    issue_title: _propTypes2.default.string
};
...
function IssueTable(props) {
    var issueRows = props.issues.map(function (issue) {
        return _react2.default.createElement(IssueRow, { issue_id: issue._id, key: issue._id, issue: issue });
    });
    return _react2.default.createElement(
        'table',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'owner', placeholder: 'Onwer' }),
