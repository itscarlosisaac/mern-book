...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Importing components
...
var IssueRow = function IssueRow(props) {
    return React.createElement(
        ...
        React.createElement(
            'td',
            null,
            props.issue.completionDate ? props.issue.completionDate.toDateString() : ' -- no date -- '
        ),
        React.createElement(
            'td',
            null,
            ...
            fetch('/api/issues', {
                ...
                if (response.ok) {
                    response.json().then(function (updatedIssues) {
                        ...
                        var newIssues = _this2.state.issues.concat(updatedIssues);
