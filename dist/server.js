...
app.post('/api/issues', (req, res) => {
    ...
    db.collection('issues').insertOne(newIssue).then(result => db.collection('issues').find({ _id: result.insertedId }).limit(1).next()).then(newIssues => res.json(newIssues)).catch(err => {
        console.log(err);
